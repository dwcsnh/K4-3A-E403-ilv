...
**Lớp:** 3A · **Phòng:** E403 · **Cụm:** 3C · **Track:** D

| Họ và tên        | Mã Học Viên | Vai trò chính                         | Phần việc đảm nhiệm trong dự án                                                                                                          |
| ---------------- | ----------- | ------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| Đào Đức Anh      | 2A202602567 | **Team Lead, AI Engineer**            | **Lead:** xây dựng work flow, code (AI pipeline,bot gateway, frontend), prompt engineering,Viết tài liệu AI spec, lên ý tưởng luồng demo |
| Nguyễn Mạnh Hải  | 2A202602988 | **Frontend Developer, Documentation** | Viết tài liệu AI spec,Code front end                                                                                                     |
| Nguyễn Quốc Tuấn | 2A202602910 | **Frontend Developer, Documentation** | Viết tài liệu AI spec, code frontend                                                                                                     |
| Trần Thu Phương  | 2A202602366 | **Data, Documentation**               | Viết tài liệu AI spec, Viết tài liệu test case data,Xây dựng ý tưởng bài toán, workflow                                                  |
| Cao Văn Trường   | 2A202602562 | **Documentation**                     | Viết tài liệu AI spec,Xây dựng ý tưởng bài toán, workflow                                                                                |
